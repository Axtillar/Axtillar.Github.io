          ...
          <div className="hidden md:flex items-center space-x-8">
            {navItems.map((item, index) => (
              ...
              >
                ...
                <span className="absolute left-0 bottom-0 w-0 h-[1px] bg-[#64ffda] transition-all duration-300 group-hover:w-full"></span>
              </a>
            ))}
            
            <button className="border border-[#64ffda] text-[#64ffda] px-4 py-2 rounded font-mono text-sm hover:bg-[#64ffda]/10 transition-colors">
              Resume
            </button>
          </div>
            ...
            >
              <div className="flex flex-col items-center justify-center h-full py-20">
                <div className="space-y-12 text-center">
                  ...
                  >
                    <button className="border border-[#64ffda] text-[#64ffda] px-6 py-3 rounded font-mono text-base hover:bg-[#64ffda]/10 transition-colors mt-8">
                      Resume
                    </button>
                  </motion.div>
                </div>
